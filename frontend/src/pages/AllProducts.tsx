...
import { Search, Filter, Heart, ShoppingCart, Grid3x3, List } from "lucide-react";
...
const products: Product[] = [
  {
    ...
    category: "tops",
    subCategory: "블라우스/셔츠",
    image: "https://images.unsplash.com/photo-1594938298603-c8148c4b2e8e?w=400",
    moq: "50",
    moqUnit: "벌",
    sizes: ["S", "M", "L", "XL"],
  },
  ...
  },
  {
    ...
    category: "tops",
    subCategory: "블라우스/셔츠",
    image: "https://images.unsplash.com/photo-1562572159-4efc207f5aff?w=400",
    moq: "30",
    moqUnit: "벌",
    sizes: ["S", "M", "L"],
  },
  ...
  },
  {
    ...
    category: "dresses",
    subCategory: "원피스",
    image: "https://images.unsplash.com/photo-1490481703813-8a8d0912db7e?w=400",
    moq: "40",
    moqUnit: "벌",
    sizes: ["S", "M", "L", "XL"],
  },
  ...
  },
  {
    ...
    category: "outerwear",
    subCategory: "가디건",
    image: "https://images.unsplash.com/photo-1609873814058-a8928924184a?w=400",
    moq: "50",
    moqUnit: "벌",
    sizes: ["FREE"],
  },
          ...
          {categories.map((cat) => (
            ...
            >
              <div className="flex items-center justify-between">
                <span>{cat.name}</span>
                <span className={`text-xs ${selectedCategory === cat.id ? "text-white/80" : "text-muted-foreground"}`}>
                  {cat.count}
                </span>
              </div>
            </button>
          ...
          {viewMode === "grid" ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
              {filteredProducts.map((product) => (
                <div
                  key={product.id}
                  className="bg-white border border-border rounded-lg overflow-hidden hover:shadow-lg hover:border-primary/50 transition-all group"
                >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Link
                          ...
                          className="border border-border text-foreground hover:border-primary hover:text-primary px-6 py-2.5 rounded-lg text-sm font-semibold transition-colors"
                        >
                          상세보기
                        </Link>
                      </div>
